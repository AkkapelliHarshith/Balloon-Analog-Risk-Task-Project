...
?>
  ...
  <div class = "lll">
   ...
   <form action="http://localhost/BART-main/feedback.php" method="POST">
    

 <div style="width:30%;color:blue;border:0px;"> <input type="submit" value="Submit" name="kkk" class="sub"  id ="ssss" style="width:600%;font-size: 20px;border:0px blue;background-color: blue;border-radius: 8px;color:white;"></div>
</form> 
</div>
</body>
</html>
