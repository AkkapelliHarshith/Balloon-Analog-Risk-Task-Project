...
?>
            ...
            <div class="lll">
                ...
                <form action="index.html" method="POST">
                    <div style="width:200%;margin-left: -150px;color:blue;border:0px;background-color:white;">
                        <input type="submit" value="Submit" name="kkk" class="sub" id="ssss" style="width:100%;font-size: 20px;border:0px ;background-color: blue;border-radius: 8px;color:white;"> </div>
                </form>
            </div>
            </body>
